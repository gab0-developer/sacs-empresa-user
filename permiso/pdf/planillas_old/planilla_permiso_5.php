...
$pdf->Cell(65, 8, utf8_decode('REGENTE DE LA CASA DE REPRESENTACIÓN'),0,1,'L',0);
...
$pdf->MultiCell(190, 4, utf8_decode("Vista y leída la Comunicación recibida el día ".$row2['fecha_solicitud'].", Acta de Inspección de fecha ".$row2['fecha_acta']." y demás documentos, este Servicio Autónomo de Contraloría Sanitaria AUTORIZA, de acuerdo con lo Establecido en los Artículos 29 y 30 del Reglamento de la Ley de Ejercicio de la Farmacia y Artículo 54 de la Ley de Medicamentos, publicada en Gaceta Oficial No. 37.006 el día 03-08-2000, la INSTALACIÓN de la CASA DE REPRESENTACIÓN denominada ".$row2['nombre_empresa'].", cuya Oficina Administrativa y el Almacén está ubicado (Dirección: ubicada en el ".$row2['direccion']."), Ciudad ".$row2['municipio'].", Estado ".$row2['estado'].", para Importar, Registrar, Representar, Almacenar, Distribuir y Comercializar Productos Farmacéuticos legalmente Registrados en el País y ha sido Registrada bajo el No. ".$row2['permiso']." LA INSTALACIÓN de este Establecimiento Farmacéutico se Autoriza la venta al MAYOR de Medicamentos legalmente Registrados en País, como lo establece el Capitulo II de la Ley de Medicamentos y debe dar cumplimiento a las Normas de Buenas Prácticas de Distribución y Almacenamiento, publicada en Gaceta Oficial No. 37.966 de fecha 23-06-2004. Para el Funcionamiento del Establecimiento, debe solicitar nueva Inspección previa presentación de las Copias de los Registros Sanitarios de los Productos Farmacéuticos que va a Importar, Representar, Comercializar, Almacenar y Distribuir en el País."), '', 'J', 0);
$pdf->Ln(3);
}
...
$pdf->MultiCell(190, 4, utf8_decode('- Ceder y traspasar la Representación a otros Establecimientos Farmacéuticos, por cuanto los permisos de Autorización concedidos por este Servicio Autónomo de Contraloría Sanitaria son INTRANSFERIBLES.'), '' ,'L', 0);
$pdf->Ln(1);


$pdf->SetFont('Arial', '', 10);

$pdf->MultiCell(190, 4, utf8_decode('Se le participa, que deben ajustarse a lo establecido en el Capítulo III "De la Promoción de los Medicamentos, Artículos 44, 45 y 46 de la Ley de Medicamentos publicada en la Gaceta Oficial No. 37.006 de fecha 03-08-2000. En caso de Traspaso, Reapertura, Traslado o cualquier modificación en las condiciones autorizadas, así como el cese Temporal o Definitivo debe estar autorizado por este Servicio Autónomo de Contraloría Sanitaria. Se le advierte, que deben ajustarse al cumplimiento de lo establecido en los Artículos 9, 10, 15, 16, 54 y 58 del Reglamento de la Ley de Ejercicio de la Farmacia y Artículo 58 de la Ley de Medicamentos. El incumplimiento de lo aquí señalado, será sancionado con lo dispuesto en las Leyes y Reglamentos que rigen sobre la materia.'), '' ,'L', 0);
$pdf->Ln(32.3);
