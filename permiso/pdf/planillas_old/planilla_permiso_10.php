...
$sql2 = "SELECT * FROM sacs.permiso_info_cr_pdf('$permiso')";
...
$pdf->MultiCell(190, 4, utf8_decode("Vista y leída la Comunicación recibida el día ".$row2['fecha_solicitud'].", Acta de Inspección de fecha ".$row2['fecha_acta']." y demás documentos, este Servicio Autónomo de Contraloría Sanitaria AUTORIZA, de acuerdo con lo Establecido en los Artículos 29 y 30 del Reglamento de la Ley de Ejercicio de la Farmacia y Artículo 54 de la Ley de Medicamentos, publicada en Gaceta Oficial No. 37.006 el día 03-08-2000, el TRASLADO y FUNCIONAMIENTO de la CASA DE REPRESENTACIÓN denominada ".$row2['nombre_empresa']." Dirección: ubicada en el ".$row2['direccion2'].", Ciudad ".$row2['municipio2'].", Estado ".$row2['estado2'].", al nuevo local, situado en la Dirección: ".$row2['direccion'].", Ciudad ".$row2['municipio'].", Estado ".$row2['estado'].", para Importar, Registrar, Representar, Almacenar, Distribuir y Comercializar sus Productos Farmacéuticos legalmente Registrados en el País y está Registrada bajo el No. ".$row2['permiso']), '', 'J', 0);
$pdf->Ln(2);
}
...
$pdf->Output('I' , 'TRASLADO Y FUNCIONAMIENTO CASA DE REPRESENTACION.pdf');
