...
$pdf = new PDF();
$pdf->AliasNbPages();
$pdf->SetTitle('Planilla7');
$pdf->AddPage('Portrait');
$pdf->SetFont('Arial', 'B', 10);
$pdf->MultiCell(0, 4, utf8_decode('SOLICITUD DE PERMISO DE FUNCIONAMIENTO PARA CASAS DE REPRESENTACIÓN,
IMPORTADORA Y/O DISTRIBUIDORA DE COSMÉTICOS E IMPORTADORAS Y/O DISTRIBUIDORAS
DE REPELENTES DE INSECTOS DE USO TÓPICO'), 0, 'C', 0);
$pdf->Ln(5);
...
$pdf->Cell(35,6, utf8_decode('CASA DE REPRESENTACIÓN'), 0,0,'L',0);
$pdf->Cell(4);
...
$pdf->Cell(42.99,6, utf8_decode('IMPORTADORA/DISTRIBUIDORA'), 0,0,'L',0);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
...
$pdf->Cell(85.99,6, utf8_decode('DISTRIBUIDORA'), 0,0,'L',0);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
if($row3['tipo_producto'] == 'REPELENTES DE INSECTOS DE USO TÓPICO'){
$pdf->Cell(4,4,utf8_decode('X'),1,0,'C',0);
}else{
$pdf->Cell(4,4,utf8_decode(''),1,0,'C',0);
}
$pdf->Cell(50.33,6, utf8_decode('REPELENTES DE INSECTOS '), 0,0,'L',0);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
if($row3['tipo_producto'] == ''){
$pdf->Cell(4,4,utf8_decode('X'),1,0,'C',0);
}else{
$pdf->Cell(4,4,utf8_decode(''),1,0,'C',0);
}
$pdf->SetFont('Arial','',5.55);
...
$pdf->Cell(85.99,6, utf8_decode('DISTRIBUIDORA DE REPELENTES DE INSECTOS DE USO TOPICO'), 0,0,'L',0);
$pdf->Cell(6, 5,utf8_decode(''),'L' ,0,'C',0);
$pdf->Cell(50.33,6, utf8_decode('DE USO TOPICO'), 0,0,'L',0);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
if($row3['tipo_producto'] == 'MATERIA PRIMA REPELENTES DE INSECTOS DE USO TÓPICO'){
$pdf->Cell(4,4,utf8_decode('X'),1,0,'C',0);
}else{
$pdf->Cell(4,4,utf8_decode(''),1,0,'C',0);
}
$pdf->SetFont('Arial', '',5.6);
$pdf->Cell(28.66, 5,utf8_decode('REPELENTES DE INSECTOS'),0 ,0,'C',0);
$pdf->SetFont('Arial', '',7);
$pdf->Cell(2);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,1,'C',0);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
$pdf->Cell(4);
$pdf->Cell(85.99,6, utf8_decode(''), 0,0,'L',0);
$pdf->Cell(6, 5,utf8_decode(''),'L' ,0,'C',0);
$pdf->Cell(50.33,6, utf8_decode(''), 0,0,'L',0);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
$pdf->Cell(4);
$pdf->SetFont('Arial', '',5.6);
$pdf->Cell(17.66, 5,utf8_decode('DE USO TOPICO'),0 ,0,'C',0);
$pdf->Cell(13);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,1,'C',0);
...
$pdf->MultiCell(185, 40, utf8_decode(''), 1, 'L', 0);
$pdf->Cell(5);
$pdf->Cell(180, 3, utf8_decode('F.15-DMC-IFV-OPP-AGOSTO 2022'), 0, 1, 'L', 0);
$pdf->Ln(6);
