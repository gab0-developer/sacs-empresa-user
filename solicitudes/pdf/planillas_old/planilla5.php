...
$pdf = new PDF();
$pdf->AliasNbPages();
$pdf->SetTitle('Planilla5');
$pdf->AddPage('Portrait');
$pdf->SetFont('Arial', 'B', 10);
$pdf->MultiCell(0, 4, utf8_decode('SOLICITUD DE PERMISO SANITARIO PARA LA INSTALACIÓN Y FUNCIONAMIENTO DE CASAS DE REPRESENTACIÓN DE PRODUCTOS FARMACÉUTICOS Y MATERIAS PRIMAS'), 0, 'C', 0);
$pdf->Ln(5);
...
$pdf->SetY(60);
$pdf->SetFont('Arial','',7);
$pdf->Cell(81.66,5, utf8_decode('TIPO DE ESTABLECIMIENTO'), 'R, T, L', 0,'L',0);
$pdf->SetFont('Arial','',6);
$pdf->Cell(57.66,5, utf8_decode('PRODUCTO TERMINADO A IMPORTAR/REPRESENTAR'), 'R, T, L', 0,'C',0);
$pdf->SetFont('Arial','',7);
$pdf->Cell(45.68,5, utf8_decode('MATERIA PRIMA A IMPORTAR'), 'R, T, L', 1,'L',0);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
if($row2['tipo_laboratorio'] == 'CASA DE REPRESENTACIÓN PRODUCTOS FARMACEUTICOS'){
$pdf->Cell(4,4,utf8_decode('X'),1,0,'C',0);
}else{
$pdf->Cell(4,4,utf8_decode(''),1,0,'C',0);
}
$pdf->Cell(42,6, utf8_decode('CASA DE REPRESENTACIÓN PRODUCTOS FARMACEUTICOS'), 0,0,'L',0);
$pdf->Cell(33.65);
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
...
$pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
if($row2['tipo_laboratorio'] == 'CASA DE REPRESENTACION DE MATERIAS PRIMAS'){
$pdf->Cell(4,4,utf8_decode('X'),1,0,'C',0);
}else{
$pdf->Cell(4,4,utf8_decode(''),1,0,'C',0);
}
$pdf->Cell(42,6, utf8_decode('CASA DE REPRESENTACION DE MATERIAS PRIMAS'), 0,0,'L',0);
$pdf->Cell(33.65);
$pdf->Cell(6, 5,utf8_decode(''),'L' ,0,'C',0);
$pdf->Cell(21,6, utf8_decode(''), 0,0,'L',0);
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->MultiCell(0, 4, utf8_decode('B.- DATOS DE LA CASA DE REPRESENTACION'), 0, 'L', 0);
$pdf->SetFont('Arial', '', 7);
$pdf->Ln(2.5);
...
$pdf->MultiCell(185, 40, utf8_decode(''), 1, 'L', 0);
$pdf->Cell(5);
$pdf->Cell(180, 3, utf8_decode('F.05-DMC-IFV-OPP-AGOSTO 2022'), 0, 1, 'L', 0);
$pdf->Ln(6);
