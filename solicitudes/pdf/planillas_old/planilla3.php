...
$pdf = new PDF();
$pdf->AliasNbPages();
$pdf->SetTitle('Planilla3');
$pdf->AddPage('Portrait');
$pdf->SetFont('Arial', 'B', 10);
$pdf->MultiCell(0, 4, utf8_decode('SOLICITUD DE PERMISO SANITARIO PARA LA INSTALACIÓN DE EMPRESAS IMPORTADORAS Y/O DISTRIBUIDORAS DE PRODUCTOS COSMETICOS Y SUS MATERIAS PRIMAS'), 0, 'C', 0);
$pdf->Ln(5);
...
while($row2 = pg_fetch_assoc($laboratorio)){
  ...
  $pdf->SetY(60);
  $pdf->Cell(61.66,5, utf8_decode('TIPO DE ESTABLECIMIENTO'), 'R, T, L', 0,'C',0);
  $pdf->SetFont('Arial','',6);
  $pdf->Cell(61.66,5, utf8_decode('PRODUCTO TERMINADO A IMPORTAR/REPRESENTAR'), 'R, T, L', 0,'C',0);
  $pdf->SetFont('Arial','',7);
  $pdf->Cell(61.66,5, utf8_decode('MATERIA PRIMA A IMPORTAR'), 'R, T, L', 1,'C',0);
  $pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
  if($row2['tipo_laboratorio'] == 'CASA DE REPRESENTACIÓN'){
  $pdf->Cell(4,4,utf8_decode('X'),1,0,'C',0);
  }else{
  $pdf->Cell(4,4,utf8_decode(''),1,0,'C',0);
  }
  $pdf->Cell(42,6, utf8_decode('CASA DE REPRESENTACIÓN'), 0,0,'L',0);
  $pdf->Cell(13.6);
  $pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
  ...
  $pdf->Cell(15,6, utf8_decode('PRODUTOS COSMETICOS'), 0,0,'L',0);
  $pdf->Cell(38.68);
  $pdf->Cell(2, 5,utf8_decode(''),'L' ,1,'C',0);
  $pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
  if($row2['tipo_laboratorio'] == 'IMPORTADORA/DISTRIBUIDORA'){
  $pdf->Cell(4,4,utf8_decode('X'),1,0,'C',0);
  }else{
  $pdf->Cell(4,4,utf8_decode(''),1,0,'C',0);  
  }
  $pdf->Cell(42,6, utf8_decode('IMPORTADORA/DISTRIBUIDORA'), 0,0,'L',0);
  $pdf->Cell(13.6);
  ...
  $pdf->Cell(15,6, utf8_decode('PRODUTOS FARMACÉUTICOS'), 0,0,'L',0);
  $pdf->Cell(38.68);
  $pdf->Cell(2, 5,utf8_decode(''),'L' ,1,'C',0);
  $pdf->Cell(2, 5,utf8_decode(''),'L' ,0,'C',0);
  ...
  $pdf->Cell(42,6, utf8_decode('DISTRIBUIDORA'), 0,0,'L',0);
  $pdf->Cell(13.6);
  $pdf->Cell(6, 5,utf8_decode(''),'L' ,0,'C',0);
  $pdf->Cell(15,6, utf8_decode(''), 0,0,'L',0);
  $pdf->Cell(10);
...
$pdf->MultiCell(0, 4, utf8_decode('A.- DATOS DEL (LA) REGENTE O FARMACÉUTICO(A) SOLICITANTE AUTORIZADO(A)'), 0, 'L', 0);
$pdf->SetFont('Arial', '', 7);
$pdf->Ln(2.5);
...
$pdf->SetFillColor(220,220,220);
$pdf->Cell(185,6, utf8_decode('DATOS DEL PODER OTORGADO POR EL PROPIETARIO DEL PRODUCTO A LA CASA DE REPRESENTACIÓN O A LA IMPORTADORA-DISTRIBUIDORA'), 1, 1,'C', 1);
$pdf->SetFillColor(225,225,225);
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->MultiCell(0, 4, utf8_decode('C.- ANEXAR LISTA DE PRODUCTOS A IMPORTAR, REPRESENTAR Y DISTRIBUIR'), 0, 'L', 0);
$pdf->SetFont('Arial', '', 7);
$pdf->Ln(2.5);
...
$pdf->MultiCell(185, 5, utf8_decode('  Yo, _____________________________________________________ portador de la Cédula de identidad N° _______________, actuando en mi carácter de Solicitante, ante el Servicio Autonómo de Contraloría Sanitaria, declaro bajo juramento corresponsablemente con la Empresa que:

  1. El contenido total de la información es absolutamente cierto y veraz.

  2. La Empresa a la que represento prestará todas las facilidades que solicite el Servicio Autonomo de Contraloría Sanitaria para poder 
      realizar los controles posteriores.
                                                                   ...
                                                                   ________________________________________________________________
                                                                            FIRMA DEL (LA) REGENTE / FARMACEUTICO(A) SOLICITANTE'),0,'J',0);
$pdf->Ln(7);
$pdf->SetFont('Arial', 'B', 9);
...
$pdf->MultiCell(185, 40, utf8_decode(''), 1, 'L', 0);
$pdf->Cell(5);
$pdf->Cell(180, 3, utf8_decode('F.03-DMC-IFV-OPP-AGOSTO 2022'), 0, 1, 'L', 0);
$pdf->Ln(6);

$pdf->AddPage('Portrait');
$pdf->SetFont('Arial', 'B', 9);
$pdf->MultiCell(0, 4, utf8_decode('C.- LISTA DE PRODUCTOS O MATERIAS PRIMAS A IMPORTAR, REPRESENTAR Y DISTRIBUIR'), 0, 'L', 0);
