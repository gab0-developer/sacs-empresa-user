...
$pdf = new PDF();
$pdf->AliasNbPages();
$pdf->SetTitle('Planilla9');
$pdf->AddPage('Portrait');
$pdf->SetFont('Arial', 'B', 10);
$pdf->MultiCell(0, 4, utf8_decode('SOLICITUD DE PERMISO SANITARIO PARA LA INSTALACIÓN DE CASAS DE REPRESENTACIÓN
DE PRODUCTOS FARMACÉUTICOS Y MATERIAS PRIMAS'), 0, 'C', 0);
$pdf->Ln(5);
...
$pdf->MultiCell(185, 40, utf8_decode(''), 1, 'L', 0);
$pdf->Cell(5);
$pdf->Cell(180, 3, utf8_decode('F.17-DMC-IFV-OPP-AGOSTO 2022'), 0, 1, 'L', 0);
$pdf->Ln(6);
